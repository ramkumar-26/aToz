...
public class OrderController {
	...
	public ResponseEntity<Order> addOrder(@RequestBody Order order,@PathVariable("key") String key) throws LoginException, CustomerException, CartException, ProductException{
	...
	public ResponseEntity<Order> updateOrder(@RequestBody Order updatedOrder,@PathVariable("key") String key) throws LoginException, CustomerException, ProductException{
	...
	public ResponseEntity<List<Order>> viewOrderByDate(@PathVariable("date") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate  date){
